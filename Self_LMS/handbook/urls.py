...
from .views import CourseListAPIView, CourseDetailAPIView, ChapterAPIView, QuizDetailAPIView, QuizListAPIView
...
urlpatterns = [
    ...
    path("api/quizzes/<int:quiz_id>/", QuizDetailAPIView.as_view(), name="api-quiz-detail"),
]